...
public class Practice3 {
 ...
 static void stat (String param1, String param2){
     System.out.println("Hello, I am a "+param1+" method. and I can visit a static/non-static method without "+param2+" but for visiting another class, I enter through the class name.");
 }
}
